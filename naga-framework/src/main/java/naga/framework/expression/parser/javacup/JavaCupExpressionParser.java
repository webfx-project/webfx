      ...
      switch (CUP$JavaCupExpressionParser$act_num)
		...
		String alias = (String)((java_cup.runtime.Symbol) CUP$JavaCupExpressionParser$stack.peek()).value;
		 RESULT = new AsBuilder(e, alias); 
              CUP$JavaCupExpressionParser$result = parser.getSymbolFactory().newSymbol("expr_list_token",10, ((java_cup.runtime.Symbol)CUP$JavaCupExpressionParser$stack.elementAt(CUP$JavaCupExpressionParser$top-2)), ((java_cup.runtime.Symbol)CUP$JavaCupExpressionParser$stack.peek()), RESULT);
            }
          return CUP$JavaCupExpressionParser$result;
