...
import webfx.fxkit.mapper.spi.impl.peer.markers.HasSceneProperty;
...
*/
     ...
     * frame handles. Typical applications will set the {@link emul.javafx.scene.Scene} width
     * instead.
     * <p>
     ...
     * bar. Typical applications will set the {@link emul.javafx.scene.Scene} height instead.
     * <p>
     * The property is read only because it can be changed externally
     * by the underlying platform and therefore must not be bindable.
     * </p>
