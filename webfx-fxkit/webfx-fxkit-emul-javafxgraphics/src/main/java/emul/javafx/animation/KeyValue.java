...
import emul.javafx.beans.value.*;
 ...
 * {@link emul.javafx.beans.value.WritableValue}, an end value and an
 * {@link Interpolator}.
 * <p>
 ...
 * a {@code KeyFrame} (see {@link  Interpolator#TANGENT(javafx.util.Duration, double, emul.javafx.util.Duration, double)
