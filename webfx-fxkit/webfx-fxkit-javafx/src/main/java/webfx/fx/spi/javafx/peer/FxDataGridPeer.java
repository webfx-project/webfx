...
import webfx.fxdata.cell.rowstyle.RowAdapter;
import webfx.fxdata.cell.rowstyle.RowStyleUpdater;
import webfx.fxdata.control.DataGrid;
import webfx.fxdata.displaydata.*;
import webfx.fxdata.displaydata.SelectionMode;
import webfx.fxdata.spi.peer.base.DataGridPeerBase;
import webfx.fxdata.spi.peer.base.DataGridPeerImageTextMixin;
import webfx.fxdata.spi.peer.base.DataGridPeerMixin;
import webfx.util.collection.IdentityList;
...
public class FxDataGridPeer
    ...
    public void setUpGridColumn(int gridColumnIndex, int rsColumnIndex, DisplayColumn displayColumn) {
        ...
        webfx.fxdata.displaydata.Label label = displayColumn.getLabel();
