...
import webfx.fx.spi.peer.base.ScrollPanePeerBase;
import webfx.fx.spi.peer.base.ScrollPanePeerMixin;
...
public final class HtmlScrollPanePeer
    ...
    private native void callPerfectScrollbarInitialize(Element element, boolean suppressScrollX, boolean suppressScrollY) /*-{
        ...
        var self = this;
        element.addEventListener('ps-scroll-x', function() { self.@webfx.fx.spi.gwt.html.peer.HtmlScrollPanePeer::setScrollLeft(D)(element.scrollLeft)});
        element.addEventListener('ps-scroll-y', function() { self.@webfx.fx.spi.gwt.html.peer.HtmlScrollPanePeer::setScrollTop(D)(element.scrollTop)});
    }-*/;

    private native void callPerfectScrollbarUpdate(Element element) /*-{
        element.scrollLeft = this.@webfx.fx.spi.gwt.html.peer.HtmlScrollPanePeer::scrollLeft;
        element.scrollTop = this.@webfx.fx.spi.gwt.html.peer.HtmlScrollPanePeer::scrollTop;
