...
import webfx.fxdata.spi.peer.base.HtmlTextEditorPeerBase;
import webfx.fxdata.spi.peer.base.HtmlTextEditorPeerMixin;
...
public class HtmlHtmlTextEditorPeer
    ...
    private static native JavaScriptObject callCKEditorReplace(Element textArea, double width, double height, HtmlHtmlTextEditorPeer javaPeer) /*-{
        return $wnd.CKEDITOR.replace(textArea, {resize_enabled: false, on: {'instanceReady': function(e) {e.editor.resize(width, height); javaPeer.@webfx.fx.spi.gwt.html.peer.HtmlHtmlTextEditorPeer::resyncEditorFromNodeText()(); e.editor.on('change', javaPeer.@webfx.fx.spi.gwt.html.peer.HtmlHtmlTextEditorPeer::resyncNodeTextFromEditor().bind(javaPeer));}}});
    }-*/;
