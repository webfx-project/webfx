...
import emul.com.sun.javafx.collections.TrackableObservableList;
import emul.com.sun.javafx.collections.VetoableListDecorator;
import emul.javafx.beans.property.ObjectProperty;
import emul.javafx.beans.property.ReadOnlyObjectProperty;
...
public class ToggleGroup {
    ...
    private final ObservableList<Toggle> toggles = new VetoableListDecorator<Toggle>(new TrackableObservableList<Toggle>() {
        @Override protected void onChanged(ListChangeListener.Change<Toggle> c) {
            while (c.next()) {
    ...
    public final void selectToggle(Toggle value) { selectedToggle.setValue(value); }

    /**
     * Gets the selected {@code Toggle}.
     * @return Toggle The selected toggle.
     */
    public final Toggle getSelectedToggle() { return selectedToggle.getValue(); }

    /**
     * The selected toggle.
     */
    public final ReadOnlyObjectProperty<Toggle> selectedToggleProperty() { return selectedToggle; }
