 ...
 * @author Bruno Salmon
 */
public abstract class SelectableDisplayResultControlSkinBase<C extends SelectableDisplayResultControl, ROW extends Node, CELL extends Node> extends DisplayResultControlSkinBase<C, ROW, CELL> {
