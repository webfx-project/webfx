...
import emul.javafx.scene.control.ContentDisplay;
import emul.javafx.scene.control.Labeled;
import emul.javafx.scene.control.OverrunStyle;
...
/*
                ...
                *//*
                ...
                if (getSkinnable().isMnemonicParsing() == true && emul.com.sun.javafx.PlatformUtil.isMac() && bindings != null) {
                    s = bindings.getText();
                }
                else {
                    s = labeled.getText();
