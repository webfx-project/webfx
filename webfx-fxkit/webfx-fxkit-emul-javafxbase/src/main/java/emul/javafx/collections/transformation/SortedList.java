...
import emul.com.sun.javafx.collections.NonIterableChange.SimplePermutationChange;
import emul.com.sun.javafx.collections.SortHelper;
...
import emul.javafx.beans.NamedArg;
import emul.javafx.beans.property.ObjectProperty;
import emul.javafx.beans.property.ObjectPropertyBase;
...
public final class SortedList<E> extends TransformationList<E, E>{
     ...
     * @see #SortedList(emul.javafx.collections.ObservableList, java.util.Comparator)
     */
