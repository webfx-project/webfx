...
package javafxemul.beans.property;

import javafxemul.beans.value.ObservableValue;
import javafxemul.beans.value.WritableValue;
...
public interface Property<T> extends ReadOnlyProperty<T>, WritableValue<T> {
     ...
     * @see #bind(javafxemul.beans.value.ObservableValue)
     */
    void unbind();
