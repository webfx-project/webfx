 ...
 * @author Bruno Salmon
 */
public abstract class SelectableDisplayResultSetControlSkinBase<C extends SelectableDisplayResultSetControl, ROW extends Node, CELL extends Node> extends DisplayResultSetControlSkinBase<C, ROW, CELL> {
