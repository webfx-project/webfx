...
import emul.com.sun.javafx.scene.EventHandlerProperties;
...
import static emul.javafx.scene.layout.PreferenceResizableNode.USE_COMPUTED_SIZE;
import static emul.javafx.scene.layout.PreferenceResizableNode.USE_PREF_SIZE;
...
public abstract class Node implements INode, EventTarget, Styleable {
     ...
     * {@code Node}. The shape classes contained in {@code emul.javafx.scene.shape}
     ...
     * {@code emul.javafx.scene.control} will implement disabled-sensitive rendering,
     * however.
     * <p>
