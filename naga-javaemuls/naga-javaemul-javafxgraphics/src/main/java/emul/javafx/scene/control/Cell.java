 ...
 *     current {@link emul.javafx.scene.control.ListView#editingIndexProperty() editing cell}
...
*/
     ...
     * fill when hovered.
     */
    public final ReadOnlyProperty<Boolean> emptyProperty() { return empty/*.getReadOnlyProperty()*/; }

    private void setEmpty(boolean value) { empty.setValue(value); }

    /**
     * Returns a boolean representing whether the cell is considered to be empty
     * or not.
     */
    public final boolean isEmpty() { return empty.getValue(); }
     ...
     */
    public final ReadOnlyProperty<Boolean> selectedProperty() { return selected/*.getReadOnlyProperty()*/; }

    void setSelected(boolean value) { selected.setValue(value); }
     ...
     * {@link emul.javafx.scene.control.ListView} control) to call this method. However,
     ...
     * {@link emul.javafx.scene.control.ListView#cellFactoryProperty() cell factory}),
