 ...
 * described at {@link emul.javafx.event.EventDispatcher EventDispatcher}.
 * <p>
 ...
 * {@link emul.javafx.scene.input.MouseDragEvent MouseDragEvent} which contains
 ...
 * at {@link emul.javafx.scene.input.DragEvent DragEvent}.
 * <p>
...
public class MouseEvent extends InputEvent {
     ...
     * started (by calling {@link emul.javafx.scene.Node#startFullDrag startFullDrag()}
     * of {@link emul.javafx.scene.Node#startDragAndDrop startDragAndDrop()} method).
...
*/
    ...
    public Event duplicate() {
        return new MouseEvent(source, target, getEventType(), x, y, screenX, screenY, button, clickCount, shiftDown, controlDown, altDown, metaDown, primaryButtonDown, middleButtonDown, secondaryButtonDown, synthesized, popupTrigger, stillSincePress, pickResult);
    }
