 ...
 * and the {@link emul.javafx.scene.layout.Region#getPadding() Region's padding} to determine the
 * Region {@link emul.javafx.scene.layout.Region#getPadding() insets}, which define the content area
