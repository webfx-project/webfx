 ...
 *
 * @see emul.javafx.scene.shape.Shape
 * @since JavaFX 2.0
 */
public enum StrokeType {

    /**
     * The stroke is applied by extending the boundary of a closed {@link emul.javafx.scene.shape.Shape}
     * node into its interior by a distance specified by the
     * {@link emul.javafx.scene.shape.Shape#strokeWidthProperty strokeWidth}.
    ...
    /**
     * The stroke is applied by thickening the boundary of the {@link emul.javafx.scene.shape.Shape}
     * node by a distance of half of the {@link emul.javafx.scene.shape.Shape#strokeWidthProperty strokeWidth}
