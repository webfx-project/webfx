 ...
 *
 */
package emul.javafx.collections.transformation;
...
import emul.javafx.collections.ObservableListBase;
import emul.javafx.collections.WeakListChangeListener;
 ...
 * and the events are delegated to {@link #sourceChanged(emul.javafx.collections.ListChangeListener.Change)}
 *
...
public abstract class TransformationList<E, F> extends ObservableListBase<E> implements ObservableList<E> {
    ...
    /**
     * This field contains the result of expression "source instanceof {@link emul.javafx.collections.ObservableList}".
     ...
     * @see #isInTransformationChain(emul.javafx.collections.ObservableList)
     */
