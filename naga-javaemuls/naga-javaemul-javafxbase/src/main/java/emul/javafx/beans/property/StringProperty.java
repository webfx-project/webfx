...
import emul.javafx.beans.binding.Bindings;
import emul.javafx.beans.value.ObservableValue;
import emul.javafx.beans.value.WritableStringValue;
 ...
 * and {@link #getName()}.
 *
 * @see emul.javafx.beans.value.ObservableStringValue
 * @see emul.javafx.beans.value.WritableStringValue
