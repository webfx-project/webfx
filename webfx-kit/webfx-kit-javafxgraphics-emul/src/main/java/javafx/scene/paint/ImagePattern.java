 ...
 * @since JavaFX 2.2
 */
public final class ImagePattern implements Paint {
    ...
    @Override public final boolean isOpaque() {
        ...
        // ditch the cast.
        return true; //((com.sun.prism.paint.ImagePattern)acc_getPlatformPaint()).isOpaque();
    }
    ...
    private Object peerPattern; // Can be used by the peer to store the underlying pattern

    public Object getPeerPattern() {
        return peerPattern;
    }

    public void setPeerPattern(Object peerPattern) {
        this.peerPattern = peerPattern;
    }
