...
public final class ScrollEvent extends GestureEvent {
    ...
    public Event duplicate() {
        return new ScrollEvent(source, target, getEventType(), getX(), getY(), getScreenX(), getScreenY(),
                isShiftDown(), isControlDown(), isAltDown(), isMetaDown(), isDirect(), isInertia(),
                deltaX, deltaY, totalDeltaX, totalDeltaY, multiplierX, multiplierY,
                textDeltaXUnits, textDeltaX, textDeltaYUnits, textDeltaY, touchCount, getPickResult());
    }
