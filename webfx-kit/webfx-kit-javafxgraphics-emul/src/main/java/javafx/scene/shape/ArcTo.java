...
public class ArcTo extends PathElement {
    ...
    *//*
    ...
    public void appendToSvgPath(StringBuilder sb) {
        sb.append(" A ").append(getRadiusX()).append(',').append(getRadiusY()).append(' ').append(getXAxisRotation()).append(' ').append(isLargeArcFlag() ? '1' : '0').append(' ').append(isSweepFlag() ? '1' : '0').append(' ').append(getX()).append(',').append(getY());
    }
}
