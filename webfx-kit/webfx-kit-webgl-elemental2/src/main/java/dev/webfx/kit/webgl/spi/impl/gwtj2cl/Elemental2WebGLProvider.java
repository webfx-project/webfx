...
import dev.webfx.kit.mapper.peers.javafxgraphics.elemental2.html.HtmlCanvasPeer;
 ...
 * @author Bruno Salmon
 */
public class Elemental2WebGLProvider extends WebGLProviderBase {
    ...
    private static dev.webfx.kit.webgl.WebGLRenderingContext getContext(Canvas canvas, String webglContextName) {
        ...
        if (jsContext == null)
            return null;
        dev.webfx.kit.webgl.WebGLRenderingContext gln = new Elemental2WebGLRenderingContext(jsContext);
