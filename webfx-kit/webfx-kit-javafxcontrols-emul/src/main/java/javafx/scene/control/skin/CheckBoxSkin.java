...
*/
        ...
        innerbox.imageUrlProperty().bind(FXProperties.compute(checkbox.selectedProperty(), selected -> selected ? "images/checkbox/checked.png" : "images/checkbox/unchecked.png"));
