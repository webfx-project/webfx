...
//            System.out.println("LAYOUT DIVIDERS X " + c.getX() + " Y " + c.getY() + " W " + (horizontal ? dividerWidth : width) + " H " + (horizontal ? height : dividerWidth));
    ...
    private final static Background HORIZONTAL_BACKGROUND = new Background(new BackgroundFill(LinearGradient.valueOf("to right, white 0%, #E0E0E0 100%"), RADII, Insets.EMPTY));
    private final static Background VERTICAL_BACKGROUND = new Background(new BackgroundFill(LinearGradient.valueOf("to bottom, white 0%, #E0E0E0 100%"), RADII, Insets.EMPTY));
}
