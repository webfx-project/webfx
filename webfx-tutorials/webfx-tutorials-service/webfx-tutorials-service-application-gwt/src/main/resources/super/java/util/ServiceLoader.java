...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            case "javafx.application.Application": return new ServiceLoader<S>(webfx.tutorials.service.ForecastServiceApplication::new);
            ...
            case "webfx.tutorials.service.services.alert.spi.AlertServiceProvider": return new ServiceLoader<S>(webfx.tutorials.service.services.alert.spi.impl.gwt.GwtAlertServiceProvider::new);
            case "webfx.tutorials.service.services.forecast.spi.ForecastServiceProvider": return new ServiceLoader<S>(webfx.tutorials.service.services.forecast.spi.impl.random.RandomForecastServiceProvider::new);
            // UNKNOWN SPI
            default:
