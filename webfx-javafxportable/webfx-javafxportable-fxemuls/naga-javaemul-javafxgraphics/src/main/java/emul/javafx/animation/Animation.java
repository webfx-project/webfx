...
import static emul.javafx.animation.TickCalculation.fromDuration;
...
*/
     ...
     *
     * @return {@link emul.javafx.collections.ObservableMap} of cue points
     */
...
*/
     ...
     * negative {@link emul.javafx.util.Duration} it will result in a jump to the
     * beginning. If the cue point has a value of
     * {@link emul.javafx.util.Duration#UNKNOWN} calling {@code jumpTo} will have no
