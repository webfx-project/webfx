...
public interface HighLevelComponentsFactory {
    ...
    default VPage createSectionPanel(String iconImageUrl, String translationKey, I18n i18n) {
        return createSectionPanel().setHeader(Toolkit.get().createHBox(PresentationActivity.createImage(iconImageUrl), PresentationActivity.createTextView(translationKey, i18n)));
    }
}
