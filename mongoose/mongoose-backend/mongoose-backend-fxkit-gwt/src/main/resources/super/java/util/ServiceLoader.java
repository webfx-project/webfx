...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "webfx.framework.ui.uirouter.UiRoute": return new ServiceLoader<S>(mongooses.core.activities.sharedends.authn.LoginRouting.ProvidedUiRoute::new, mongooses.core.sharedends.actvities.authz.UnauthorizedRouting.ProvidedUiRoute::new, mongooses.core.backend.activities.authorizations.AuthorizationsRouting.ProvidedUiRoute::new, mongooses.core.backend.activities.organizations.OrganizationsRouting.ProvidedUiRoute::new, mongooses.core.backend.activities.operations.OperationsRouting.ProvidedUiRoute::new, mongooses.core.backend.activities.monitor.MonitorRouting.ProvidedUiRoute::new, mongooses.core.backend.activities.letters.LettersRouting.ProvidedUiRoute::new, mongooses.core.backend.activities.letter.LetterRouting.ProvidedUiRoute::new, mongooses.core.backend.activities.events.EventsRouting.ProvidedUiRoute::new, mongooses.core.backend.activities.bookings.BookingsRouting.ProvidedUiRoute::new, mongooses.core.backend.activities.cloneevent.CloneEventRouting.ProvidedUiRoute::new);
            case "webfx.framework.operations.route.RouteRequestEmitter": return new ServiceLoader<S>(mongooses.core.backend.activities.authorizations.RouteToAuthorizationsRequest.ProvidedEmitter::new, mongooses.core.backend.operations.organizations.RouteToOrganizationsRequest.ProvidedEmitter::new, mongooses.core.backend.operations.operations.RouteToOperationsRequest.ProvidedEmitter::new, mongooses.core.backend.operations.monitor.RouteToMonitorRequest.ProvidedEmitter::new, mongooses.core.backend.operations.letters.RouteToLettersRequest.ProvidedEmitter::new, mongooses.core.backend.operations.events.RouteToEventsRequest.ProvidedEmitter::new, mongooses.core.backend.operations.bookings.RouteToBookingsRequest.ProvidedEmitter::new);
            case "webfx.platforms.core.services.appcontainer.spi.ApplicationModuleInitializer": return new ServiceLoader<S>(webfx.fxkits.core.launcher.FxKitLauncherModuleInitializer::new, mongooses.core.backend.start.MongooseBackendApplicationModuleInitializer::new, webfx.platforms.core.services.buscall.BusCallModuleInitializer::new, webfx.platforms.core.services.json.codec.JsonCodecModuleInitializer::new, webfx.platform.gwt.services.resource.GwtResourceModuleInitializer::new);
            case "webfx.platforms.core.services.json.codec.JsonCodec": return new ServiceLoader<S>(webfx.platforms.core.services.query.QueryArgument.Codec::new, webfx.platforms.core.services.query.QueryResult.Codec::new, webfx.platforms.core.services.buscall.BusCallArgument.Codec::new, webfx.platforms.core.services.buscall.BusCallResult.Codec::new, webfx.platforms.core.services.buscall.SerializableAsyncResult.Codec::new, webfx.platforms.core.services.update.UpdateArgument.Codec::new, webfx.platforms.core.services.update.UpdateResult.Codec::new, webfx.platforms.core.services.update.GeneratedKeyBatchIndex.Codec::new, webfx.platforms.core.services.querypush.QueryPushArgument.Codec::new, webfx.platforms.core.services.querypush.QueryPushResult.Codec::new, webfx.platforms.core.services.querypush.diff.impl.QueryResultTranslation.Codec::new, webfx.platforms.core.services.json.codec.BatchJsonCodec::new);
