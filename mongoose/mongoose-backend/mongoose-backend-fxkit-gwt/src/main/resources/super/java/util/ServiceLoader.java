...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "webfx.platforms.core.services.appcontainer.spi.ApplicationModuleInitializer": return new ServiceLoader<S>(webfx.fxkits.core.launcher.FxKitLauncherModuleInitializer::new, mongooses.core.backend.start.MongooseBackendApplicationModuleInitializer::new, webfx.platforms.core.services.buscall.BusCallModuleInitializer::new, webfx.platforms.core.services.serial.SerialCodecModuleInitializer::new, webfx.platform.gwt.services.resource.GwtResourceModuleInitializer::new);
            case "webfx.platforms.core.services.serial.SerialCodec": return new ServiceLoader<S>(webfx.platforms.core.services.query.QueryArgument.ProvidedSerialCodec::new, webfx.platforms.core.services.query.QueryResult.ProvidedSerialCodec::new, webfx.platforms.core.services.buscall.BusCallArgument.ProvidedSerialCodec::new, webfx.platforms.core.services.buscall.BusCallResult.ProvidedSerialCodec::new, webfx.platforms.core.services.buscall.SerializableAsyncResult.ProvidedSerialCodec::new, webfx.platforms.core.services.update.UpdateArgument.ProvidedSerialCodec::new, webfx.platforms.core.services.update.UpdateResult.ProvidedSerialCodec::new, webfx.platforms.core.services.update.GeneratedKeyBatchIndex.ProvidedSerialCodec::new, webfx.platforms.core.services.querypush.QueryPushArgument.ProvidedSerialCodec::new, webfx.platforms.core.services.querypush.QueryPushResult.ProvidedSerialCodec::new, webfx.platforms.core.services.querypush.diff.impl.QueryResultTranslation.ProvidedSerialCodec::new, webfx.platforms.core.services.serial.ProvidedBatchSerialCodec::new);
