...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "webfx.framework.client.ui.uirouter.UiRoute": return new ServiceLoader<S>(mongoose.client.activities.login.LoginUiRoute::new, mongoose.client.activities.unauthorized.UnauthorizedUiRoute::new, mongoose.backend.activities.authorizations.AuthorizationsUiRoute::new, mongoose.backend.activities.bookings.BookingsUiRoute::new, mongoose.backend.activities.cloneevent.CloneEventUiRoute::new, mongoose.backend.activities.diningareas.DiningAreasUiRoute::new, mongoose.backend.activities.statistics.StatisticsUiRoute::new, mongoose.backend.activities.events.EventsUiRoute::new, mongoose.backend.activities.income.IncomeUiRoute::new, mongoose.backend.activities.monitor.MonitorUiRoute::new, mongoose.backend.activities.letters.LettersUiRoute::new, mongoose.backend.activities.letter.LetterUiRoute::new, mongoose.backend.activities.payments.PaymentsUiRoute::new, mongoose.backend.activities.statements.StatementsUiRoute::new, mongoose.backend.activities.users.UsersUiRoute::new, mongoose.backend.activities.operations.OperationsUiRoute::new, mongoose.backend.activities.organizations.OrganizationsUiRoute::new);
