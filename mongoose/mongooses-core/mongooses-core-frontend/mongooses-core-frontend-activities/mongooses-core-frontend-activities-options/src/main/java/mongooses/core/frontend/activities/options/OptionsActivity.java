...
import mongooses.core.frontend.operations.person.RouteToPersonRequest;
...
public class OptionsActivity extends BookingProcessActivity {
    ...
    protected Node createLabelNode(mongooses.core.shared.entities.Label label) {
    ...
    protected void updateLabelText(mongooses.core.shared.entities.Label label) {
