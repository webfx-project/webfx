...
public class OptionsActivity extends BookingProcessActivity {
    ...
    protected Node createLabelNode(mongooses.core.entities.Label label) {
    ...
    private Map<mongooses.core.entities.Label, Property<String>> labelTexts = new HashMap<>();

    private void bindTextWithLabel(Property<String> textProperty, mongooses.core.entities.Label label) {
        textProperty.bind(Labels.translateLabel(label));
        labelTexts.put(label, textProperty);
    }

    protected void updateLabelText(mongooses.core.entities.Label label) {
