...
import mongoose.backend.operations.roomsgraphic.ChangeResourceConfigurationItemRequest;
import mongoose.backend.operations.roomsgraphic.DeleteResourceRequest;
import mongoose.backend.operations.roomsgraphic.EditResourceConfigurationPropertiesRequest;
import mongoose.backend.operations.roomsgraphic.ToggleResourceConfigurationOnlineOfflineRequest;
