...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "webfx.platform.gwt.services.resource.GwtResourceBundle": return new ServiceLoader<S>(mongoose.client.application.gwt.MongooseClientWebBundle.ResourceBundle::new, mongoose.client.services.i18n.gwt.MongooseClientI18nGwtBundle.ProvidedGwtResourceBundle::new, mongoose.shared.domain.gwt.MongooseDomainSnapshotGwtBundle.ProvidedGwtResourceBundle::new);
            // SPI NOT FOUND
            default:
