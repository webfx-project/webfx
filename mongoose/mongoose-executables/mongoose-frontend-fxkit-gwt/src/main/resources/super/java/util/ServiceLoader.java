...
import webfx.platforms.core.services.appcontainer.spi.impl.ApplicationJobsStarter;
...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "webfx.platforms.core.services.appcontainer.spi.ApplicationModuleInitializer": return new ServiceLoader<S>(webfx.fxkits.core.launcher.FxKitLauncherModuleInitializer::new, mongoose.frontend.start.MongooseFrontendApplicationModuleInitializer::new, webfx.platforms.core.services.buscall.BusCallModuleInitializer::new, ApplicationJobsStarter::new, webfx.platforms.core.services.serial.SerialCodecModuleInitializer::new, webfx.platform.gwt.services.resource.GwtResourceModuleInitializer::new);
