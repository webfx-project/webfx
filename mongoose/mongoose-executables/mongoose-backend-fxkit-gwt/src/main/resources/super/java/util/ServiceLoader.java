...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "webfx.framework.client.operations.route.RouteRequestEmitter": return new ServiceLoader<S>(mongoose.backend.activities.authorizations.RouteToAuthorizationsRequestEmitter::new, mongoose.backend.activities.organizations.RouteToOrganizationsRequestEmitter::new, mongoose.backend.activities.operations.RouteToOperationsRequestEmitter::new, mongoose.backend.activities.monitor.RouteToMonitorRequestEmitter::new, mongoose.backend.activities.letters.RouteToLettersRequestEmitter::new, mongoose.backend.activities.events.RouteToEventsRequestEmitter::new, mongoose.backend.activities.bookings.RouteToBookingsRequestEmitter::new);
