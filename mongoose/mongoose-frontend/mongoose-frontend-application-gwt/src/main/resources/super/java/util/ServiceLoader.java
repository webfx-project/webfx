...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "webfx.framework.shared.services.domainmodelloader.spi.DomainModelLoaderProvider": return new ServiceLoader<S>(mongoose.shared.services.domainmodel.MongooseDomainModelProvider::new);
