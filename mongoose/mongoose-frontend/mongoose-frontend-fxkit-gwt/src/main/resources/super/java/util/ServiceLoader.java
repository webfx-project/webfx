...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "webfx.platforms.core.services.json.codec.JsonCodec": return new ServiceLoader<S>(webfx.platforms.core.services.json.codec.BatchJsonCodec::new, webfx.platforms.core.services.query.QueryArgument.Codec::new, webfx.platforms.core.services.query.QueryResult.Codec::new, webfx.platforms.core.services.update.UpdateArgument.Codec::new, webfx.platforms.core.services.update.UpdateResult.Codec::new, webfx.platforms.core.services.update.GeneratedKeyBatchIndex.Codec::new, webfx.platforms.core.services.querypush.QueryPushArgument.Codec::new, webfx.platforms.core.services.querypush.QueryPushResult.Codec::new, webfx.platforms.core.services.querypush.diff.impl.QueryResultTranslation.Codec::new, webfx.platforms.core.services.buscall.BusCallArgument.Codec::new, webfx.platforms.core.services.buscall.BusCallResult.Codec::new, webfx.platforms.core.services.buscall.SerializableAsyncResult.Codec::new);
            case "webfx.platforms.core.services.appcontainer.spi.ApplicationModuleInitializer": return new ServiceLoader<S>(mongooses.frontend.MongooseFrontendApplicationModuleInitializer::new, webfx.platforms.core.services.json.codec.JsonCodecModuleInitializer::new, webfx.fxkits.core.launcher.FxKitLauncherModuleInitializer::new, webfx.platforms.core.services.buscall.BusCallModuleInitializer::new, webfx.platform.gwt.services.resource.GwtResourceModuleInitializer::new);
