...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        ...
        if (serviceClass.equals(webfx.platforms.core.services.appcontainer.spi.ApplicationModuleInitializer.class)) return new ServiceLoader<S>(mongooses.web.activities.sharedends.MongooseWebApplicationModuleInitializer::new, mongooses.frontend.MongooseFrontendApplicationModuleInitializer::new, webfx.fxkits.core.FxKitModuleInitializer::new, webfx.platforms.core.services.buscall.BusCallModuleInitializer::new, webfx.platforms.core.services.json.codec.JsonCodecModuleInitializer::new);
