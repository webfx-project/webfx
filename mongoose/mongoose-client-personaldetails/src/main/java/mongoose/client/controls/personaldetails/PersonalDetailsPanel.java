...
public final class PersonalDetailsPanel implements MongooseButtonFactoryMixin {
    ...
    private Node createPersonDataGrid() {
        ...
        rsb.setValue(0, 0, I18n.instantTranslateText("FirstName:"));
        rsb.setValue(0, 1, model.getFirstName());
        rsb.setValue(1, 0, I18n.instantTranslateText("LastName:"));
        rsb.setValue(1, 1, model.getLastName());
        rsb.setValue(2, 0, I18n.instantTranslateText("Gender:"));
        rsb.setValue(2, 1, I18n.instantTranslateText(Booleans.isTrue(model.isMale()) ? "Male" : "Female"));
        rsb.setValue(3, 0, I18n.instantTranslateText("Age:"));
        rsb.setValue(3, 1, I18n.instantTranslateText(model.getAge() == null ? "Adult" : model.getAge()));
        rsb.setValue(4, 0, I18n.instantTranslateText("Email:"));
        rsb.setValue(4, 1, model.getEmail());
        rsb.setValue(5, 0, I18n.instantTranslateText("Phone:"));
        rsb.setValue(5, 1, model.getPhone());
        rsb.setValue(0, 2, I18n.instantTranslateText("Centre:"));
        rsb.setValue(0, 3, organization == null ? I18n.instantTranslateText("NoCentre") : organization.getName());
        rsb.setValue(1, 2, I18n.instantTranslateText("Street:"));
        rsb.setValue(1, 3, model.getStreet());
        rsb.setValue(2, 2, I18n.instantTranslateText("Postcode:"));
        rsb.setValue(2, 3, model.getPostCode());
        rsb.setValue(3, 2, I18n.instantTranslateText("City:"));
        rsb.setValue(3, 3, model.getCityName());
        rsb.setValue(4, 2, I18n.instantTranslateText("State:"));
        //rsb.setValue(5, 1, model.getPostCode());
        rsb.setValue(5, 2, I18n.instantTranslateText("Country:"));
