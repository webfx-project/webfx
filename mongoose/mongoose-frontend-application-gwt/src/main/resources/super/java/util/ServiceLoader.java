...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "webfx.framework.client.ui.uirouter.UiRoute": return new ServiceLoader<S>(mongoose.frontend.activities.contactus.ContactUsUiRoute::new, mongoose.frontend.activities.options.OptionsUiRoute::new, mongoose.client.activities.login.LoginUiRoute::new, mongoose.frontend.activities.startbooking.StartBookingUiRoute::new, mongoose.frontend.activities.person.PersonUiRoute::new, mongoose.client.activities.unauthorized.UnauthorizedUiRoute::new, mongoose.frontend.activities.payment.PaymentUiRoute::new, mongoose.frontend.activities.fees.FeesUiRoute::new, mongoose.frontend.activities.terms.TermsUiRoute::new, mongoose.frontend.activities.cart.CartUiRoute::new, mongoose.frontend.activities.summary.SummaryUiRoute::new, mongoose.frontend.activities.program.ProgramUiRoute::new);
