package naga.toolkit.providers.javafx;
...
import naga.toolkit.providers.javafx.nodes.charts.*;
import naga.toolkit.providers.javafx.nodes.controls.*;
import naga.toolkit.providers.javafx.nodes.gauges.FxGauge;
import naga.toolkit.providers.javafx.nodes.layouts.FxHBox;
import naga.toolkit.providers.javafx.nodes.layouts.FxVBox;
import naga.toolkit.providers.javafx.nodes.layouts.FxVPage;
import naga.toolkit.providers.javafx.nodes.layouts.FxWindow;
...
public class JavaFxToolkit extends Toolkit {
    ...
    protected JavaFxToolkit(Factory<Window> windowFactory) {
        ...
        registerNodeFactoryAndWrapper(ToggleSwitch.class, FxToggleSwitch::new, naga.toolkit.providers.javafx.nodes.controlsfx.ToggleSwitch.class, FxToggleSwitch::new);
