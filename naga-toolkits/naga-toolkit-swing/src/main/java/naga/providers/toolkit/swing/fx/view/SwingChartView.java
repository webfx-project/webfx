 ...
 * @author Bruno Salmon
 */
abstract class SwingChartView
        <N extends Chart, NV extends ChartViewBase<XChartJPanel, N, NV, NM>, NM extends ChartViewMixin<XChartJPanel, N, NV, NM>>
        extends SwingRegionView<N, NV, NM>
        implements ChartViewMixin<XChartJPanel, N, NV, NM>, SwingLayoutMeasurable<N> {

    private final XChartJPanel xChartJPanel = new XChartJPanel();

    SwingChartView(NV base) {
        super(base);
    }
