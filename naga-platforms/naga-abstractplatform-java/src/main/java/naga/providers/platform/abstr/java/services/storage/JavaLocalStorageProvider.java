package naga.providers.platform.abstr.java.services.storage;
 ...
 * @author Bruno Salmon
 */
public class JavaLocalStorageProvider extends JavaStorageProvider implements LocalStorageProvider {
