...
public class JdbcQueryService extends RemoteQueryService {
    ...
    public static JdbcQueryService JDBC_SQL_SERVICE = new JdbcQueryService();
    ...
    static class JdbcConnectedQueryService implements QueryService {

        private final DataSource jdbcDataSource;

        public JdbcConnectedQueryService(ConnectionDetails connectionDetails) {
        ...
        private Statement getStatement(QueryArgument arg, Connection connection) throws SQLException {
            ...
            PreparedStatement ps = connection.prepareStatement(arg.getQueryString());
        ...
        private ResultSet executeStatement(QueryArgument arg, Statement statement) throws SQLException {
            if (statement instanceof PreparedStatement)
                return ((PreparedStatement) statement).executeQuery();
            return statement.executeQuery(arg.getQueryString());
        }
    }
}
