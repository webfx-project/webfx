...
module webfx.platform.vertx.appcontainer.impl {
    ...
    // Workaround for Vert.x 3.9.0 / 3.9.1 (see https://github.com/vert-x3/vertx-web/issues/1616)
    requires com.fasterxml.jackson.databind; // Be careful: Temporary manually added! (not generated by WebFx)
