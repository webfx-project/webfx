package webfx.platform.gwt.services.websocket;
...
final class GwtWebSocket extends JavaScriptObject implements WebSocket {
    ...
    public native void setListener(WebSocketListener listener) /*-{
        ...
        this.onclose =   listener.@WebSocketListener::onClose(Lwebfx/platforms/core/services/json/JsonObject;).bind(listener);
    }-*/;
