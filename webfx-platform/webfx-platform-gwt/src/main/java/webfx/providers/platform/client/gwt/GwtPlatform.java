package webfx.providers.platform.client.gwt;

import webfx.platform.services.resource.ResourceService;
import webfx.platform.spi.Platform;
import webfx.providers.platform.abstr.web.WebPlatform;
...
import webfx.providers.platform.client.gwt.url.history.GwtWindowHistory;
import webfx.providers.platform.client.gwt.url.location.GwtWindowLocation;
