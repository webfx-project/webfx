...
import webfx.platform.services.query.push.diff.QueryResultComparator;
import webfx.platform.services.query.push.diff.QueryResultDiff;
 ...
 * @author Bruno Salmon
 */
public abstract class QueryPushServiceProviderImplBase implements QueryPushServiceProvider {
    private PulsePass pulsePass;

    protected QueryPushServiceProviderImplBase() {
