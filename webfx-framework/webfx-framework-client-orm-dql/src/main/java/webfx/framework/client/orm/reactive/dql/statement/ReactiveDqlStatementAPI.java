...
public interface ReactiveDqlStatementAPI<E, THIS> {
    ...
    default THIS ifFalse(ObservableValue<Boolean> property, Callable<DqlStatement> toDqlStatementCallable) {
        getReactiveDqlStatement().ifFalse(property, toDqlStatementCallable);
        return (THIS) this;
    }

    default THIS combineStringIfFalse(ObservableValue<Boolean> ifProperty, Callable<String> toDqlStatementStringCallable) {
        getReactiveDqlStatement().combineStringIfFalse(ifProperty, toDqlStatementStringCallable);
        return (THIS) this;
    }
    ...
    default <T> THIS ifNotNullOtherwiseForceEmpty(ObservableValue<T> property, Converter<T, DqlStatement> toDqlStatementConverter) {
        getReactiveDqlStatement().ifNotNullOtherwiseForceEmpty(property, toDqlStatementConverter);
        return (THIS) this;
    }

    default <T> THIS ifNotNullOtherwiseForceEmptyString(ObservableValue<T> property, Converter<T, String> toDqlStatementStringConverter) {
        getReactiveDqlStatement().ifNotNullOtherwiseForceEmptyString(property, toDqlStatementStringConverter);
        return (THIS) this;
    }
}
