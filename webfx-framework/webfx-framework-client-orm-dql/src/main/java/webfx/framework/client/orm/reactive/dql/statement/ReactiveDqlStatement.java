...
public final class ReactiveDqlStatement<E> implements ReactiveDqlStatementAPI<E, ReactiveDqlStatement<E>> {
    ...
    private Callable<DqlStatement> stringToDqlStatementCallable(Callable<String> toDqlStatementStringCallable) {
        return () -> DqlStatement.parse(toDqlStatementStringCallable.call());
    }

    @Override
    public ReactiveDqlStatement<E> ifFalse(ObservableValue<Boolean> property, Callable<DqlStatement> toDqlStatementCallable) {
        return always(property, value -> Booleans.isFalse(value) ? toDqlStatementCallable.call() : null);
    }

    @Override
    public ReactiveDqlStatement<E> combineStringIfFalse(ObservableValue<Boolean> ifProperty, Callable<String> toDqlStatementStringCallable) {
        return ifFalse(ifProperty, stringToDqlStatementCallable(toDqlStatementStringCallable));
    }
    ...
    @Override
    public <T> ReactiveDqlStatement<E> ifNotNullOtherwiseForceEmpty(ObservableValue<T> property, Converter<T, DqlStatement> toDqlStatementConverter) {
        return ifNotNullOtherwise(property, toDqlStatementConverter, DqlStatement.EMPTY_STATEMENT);
    }

    @Override
    public <T> ReactiveDqlStatement<E> ifNotNullOtherwiseForceEmptyString(ObservableValue<T> property, Converter<T, String> toDqlStatementStringConverter) {
        return ifNotNullOtherwiseForceEmpty(property, stringToDqlStatementConverter(toDqlStatementStringConverter));
    }
    ...
    protected static <E> ReactiveDqlStatement<E> initializeMaster(ReactiveDqlStatement<E> master, Object pm) {
        ...
        if (pm instanceof HasConditionDqlStatementProperty)
            master.ifNotNullOtherwiseForceEmpty(((HasConditionDqlStatementProperty) pm).conditionDqlStatementProperty(), conditionDqlStatement -> conditionDqlStatement);
        if (pm instanceof HasColumnsDqlStatementProperty)
            master.ifNotNullOtherwiseForceEmpty(((HasColumnsDqlStatementProperty) pm).columnsDqlStatementProperty(), columnsDqlStatement -> columnsDqlStatement);
    ...
    protected static <E> ReactiveDqlStatement<E> initializeGroup(ReactiveDqlStatement<E> group, Object pm) {
        ...
        if (pm instanceof HasConditionDqlStatementProperty)
            group.ifNotNullOtherwiseForceEmpty(((HasConditionDqlStatementProperty) pm).conditionDqlStatementProperty(), conditionDqlStatement -> conditionDqlStatement);
        if (pm instanceof HasGroupDqlStatementProperty)
            group.ifNotNullOtherwiseForceEmpty(((HasGroupDqlStatementProperty) pm).groupDqlStatementProperty(), groupDqlStatement -> groupDqlStatement.getGroupBy() != null ? groupDqlStatement : DqlStatement.EMPTY_STATEMENT);
        return group;
    }
