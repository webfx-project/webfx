...
public final class EqlFilter {
    ...
    public static EqlFilter parse(String eqlFilterString) {
        return eqlFilterString == null ? null : new EqlFilter(eqlFilterString);
    }

    public EqlFilter(Object domainClassId, String alias, String fields, String where, String groupBy, String having, String orderBy, String limit, String columns) {
    ...
    public EqlFilter(JsonObject json) {
    ...
    public EqlFilter(String eqlFilterString) {
        this(Json.parseObject(eqlFilterString));
    }
