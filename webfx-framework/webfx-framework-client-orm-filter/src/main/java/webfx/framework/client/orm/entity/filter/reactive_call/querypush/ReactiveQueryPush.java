 ...
 * @author Bruno Salmon
 */
public class ReactiveQueryPush extends ReactiveQuery {

    private final ReactiveQueryPush parent;
    private final List<ReactiveQueryPush> children = new ArrayList<>();
    ...
    public ReactiveQueryPush() {
        this(null);
    }

    public ReactiveQueryPush(ReactiveQueryPush parent) {
        super(null);
        this.parent = parent;
        if (parent != null)
    ...
    public ReactiveQueryPush setPushClientId(Object pushClientId) {
    ...
    protected void callAsyncFunction() {
        ...
        QueryPushService.executeQueryPush(new QueryPushArgument(
            ...
            if (refreshChildren)
                children.forEach(ReactiveQueryPush::fireCallWhenReady);
        });
