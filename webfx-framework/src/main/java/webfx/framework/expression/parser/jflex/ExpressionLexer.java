 ...
 * from the specification file <tt>C:/dev/git-repos/naga/webfx/webfx-framework/src/main/java/webfx/framework/expression/parser/jflex/ExpressionLexer.flex</tt>
 */
