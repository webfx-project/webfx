 ...
 * from the specification file <tt>C:/dev/git-repos/webfx/webfx-framework/webfx-framework-shared-expression/src/main/java/webfx/framework/shared/expression/parser/jflex/ExpressionLexer.flex</tt>
 */
