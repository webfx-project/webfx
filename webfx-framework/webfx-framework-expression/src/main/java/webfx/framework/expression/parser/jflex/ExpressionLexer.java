 ...
 * from the specification file <tt>C:/dev/git-repos/webfx/webfx-framework/webfx-framework-expression/src/main/java/webfx/framework/expression/parser/jflex/ExpressionLexer.flex</tt>
 */
