...
public class Numbers {
    ...
    static {
         ...
         * naga-util module is the StandardNumbersProviderImpl which finally uses the java.lang.Number class to reduce the
         * usage of instanceof operator (which is more consequent in the CldcPlatformNumbers provider). But the
         * naga-platform-cn1 changes it to StandardNumbersProviderImpl.
         */
    }
