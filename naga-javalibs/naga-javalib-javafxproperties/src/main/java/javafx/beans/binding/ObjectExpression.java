...
// NAGA import com.sun.javafx.binding.StringFormatter;
// NAGA import com.sun.com.sun.javafx.collections.annotations.ReturnsUnmodifiableCollection;
...
public abstract class ObjectExpression<T> implements ObservableObjectValue<T> {
     ...
     */
    /* NAGA public static <T> ObjectExpression<T> objectExpression(
        ...
        return value instanceof ObjectExpression ? (ObjectExpression<T>) value
                : new ObjectBinding<T>() {
                    ...
                    @Override
                    // NAGA @ReturnsUnmodifiableCollection
     ...
     */
    /* NAGA public BooleanBinding isEqualTo(final ObservableObjectValue<?> other) {
     ...
     * @return the new {@code BooleanExpression}
     */
    /* NAGA public BooleanBinding isEqualTo(final Object other) {
        return Bindings.equal(this, other);
    } */
     ...
     *             if {@code other} is {@code null}
     */
    /* NAGA public BooleanBinding isNotEqualTo(final ObservableObjectValue<?> other) {
     ...
     * @return the new {@code BooleanExpression}
     */
    /* NAGA public BooleanBinding isNotEqualTo(final Object other) {
        return Bindings.notEqual(this, other);
    } */
     ...
     */
    /* NAGA public BooleanBinding isNull() {
     ...
     * @return the new {@code BooleanBinding}
     */
    /* NAGA public BooleanBinding isNotNull() {
     ...
     * @since JavaFX 8.0
     */
    /* NAGA public StringBinding asString() {
     ...
     * @since JavaFX 8.0
     */
    /* NAGA public StringBinding asString(String format) {
     ...
     * @since JavaFX 8.0
     */
    /* NAGA public StringBinding asString(Locale locale, String format) {
