...
import naga.toolkit.drawing.scene.layout.FlowPane;

import java.util.ArrayList;
import java.util.List;

import static naga.toolkit.drawing.geometry.Orientation.HORIZONTAL;
import static naga.toolkit.drawing.geometry.Orientation.VERTICAL;

/**
 * @author Bruno Salmon
 */
public class FlowPaneImpl extends PaneImpl implements FlowPane {
    ...
    private static final Callback<Node, Insets> marginAccessor = FlowPaneImpl::getMargin;
    ...
    public FlowPaneImpl(Orientation orientation) {
        this();
        setOrientation(orientation);
    }

    public FlowPaneImpl(double hgap, double vgap) {
        this();
        setHgap(hgap);
        setVgap(vgap);
    }

    public FlowPaneImpl(Orientation orientation, double hgap, double vgap) {
        this();
        setOrientation(orientation);
        setHgap(hgap);
        setVgap(vgap);
    ...
    public FlowPaneImpl(Node... children) {
        super();
        getChildren().addAll(children);
    }

    public FlowPaneImpl(Orientation orientation, Node... children) {
        this();
        setOrientation(orientation);
        getChildren().addAll(children);
    }

    public FlowPaneImpl(double hgap, double vgap, Node... children) {
        this();
        setHgap(hgap);
        setVgap(vgap);
        getChildren().addAll(children);
    ...
    public FlowPaneImpl(Orientation orientation, double hgap, double vgap, Node... children) {
        this();
        setOrientation(orientation);
        setHgap(hgap);
        setVgap(vgap);
