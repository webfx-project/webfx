 ...
 * @author Bruno Salmon
 */
public abstract class Scene implements
        HasRootProperty,
        HasWidthProperty,
        HasHeightProperty {
...
/*
                ...
                if (root instanceof Parent && root instanceof PreferenceResizableNode)
                    ((Parent) root).setBindHeightToPrefHeight(true);
*/
            }
        }
    };
    ...
    protected Scene(NodeViewerFactory nodeViewerFactory) {
