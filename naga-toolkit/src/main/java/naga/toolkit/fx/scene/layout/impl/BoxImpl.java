...
import naga.toolkit.fx.scene.layout.Box;
 ...
 * @author Bruno Salmon
 */
class BoxImpl extends PaneImpl implements Box {
    ...
    static final Callback<Node, Insets> marginAccessor = BoxImpl::getMargin;
    ...
    BoxImpl(double spacing, Node... children) {
        this();
        setSpacing(spacing);
        getChildren().addAll(children);
    }
