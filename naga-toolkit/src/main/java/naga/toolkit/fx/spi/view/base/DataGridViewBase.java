 ...
 * @author Bruno Salmon
 */
public class DataGridViewBase<C>
        extends SelectableDisplayResultSetControlViewBase<C, DataGrid, DataGridViewBase<C>, DataGridViewMixin<C>>
        implements DataGridView {

    private int rowStyleColumnIndex;
    private int gridColumnCount;
    private DisplayResultSet rs;
    private DataGridViewImageTextMixin<C> imageTextMixin;
    ...
    @Override
    public void setMixin(DataGridViewMixin<C> mixin) {
        super.setMixin(mixin);
        imageTextMixin = mixin instanceof DataGridViewImageTextMixin ? (DataGridViewImageTextMixin<C>) mixin : null;
    }
