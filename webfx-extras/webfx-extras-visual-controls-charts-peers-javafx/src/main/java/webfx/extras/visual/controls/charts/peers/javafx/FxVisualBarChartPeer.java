...
public final class FxVisualBarChartPeer
        <FxN extends javafx.scene.chart.BarChart, N extends VisualBarChart, NB extends VisualBarChartPeerBase<FxN, N, NB, NM>, NM extends VisualBarChartPeerMixin<FxN, N, NB, NM>>
