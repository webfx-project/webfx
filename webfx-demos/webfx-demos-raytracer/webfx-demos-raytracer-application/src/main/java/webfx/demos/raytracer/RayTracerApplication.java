...
import webfx.demos.mandelbrot.tracerframework.TracerView;
...
public final class RayTracerApplication extends Application {
    ...
    private final static int REQUESTED_WIDTH = 480, REQUESTED_HEIGHT = 480; // Initial requested size but final size will probably be different when running in the browser
    ...
    public void start(Stage primaryStage) {
        ...
        scene.setRoot(new TracerView(canvasWidth, canvasHeight, new RayTracerPixelComputer()).buildView());
