...
public class MandelbrotComputation {
    ...
    public static MandelbrotPoint convertCanvasPixelToModelPoint(int x, int y, int canvasWidth, int canvasHeight, MandelbrotViewport viewport) {
    ...
    public static MandelbrotPoint convertCanvasPixelToModelPoint(int x, int y, int canvasWidth, int canvasHeight, BigDecimal xmin, BigDecimal xmax, BigDecimal ymin, BigDecimal ymax) {
        ...
        if (y != mbp.cpy) {
            mbp.yval = ymax.subtract(mbp.dy.multiply(BigDecimal.valueOf(mbp.cpy = y)));
