...
import naga.core.orm.expression.term.function.java.Coalesce;
import naga.core.orm.expression.term.function.java.DateIntervalFormat;
...
public class Function<T> {
    ...
    static {
        ...
        register(new InlineFunction("image", "src", new Type[]{PrimType.STRING}, "src"));
        ...
        //register(new InlineFunction("searchMatchesDocument", "d", new Type[]{new Type(DataSource.getDataSource(3L).getDataModel().getClass("Document"))}, "d..ref=?searchInteger or d..person_abcNames like ?abcSearchLike or d..person_email like ?searchEmailLike"));
        //register(new InlineFunction("searchMatchesPerson", "p", new Type[]{new Type(DataSource.getDataSource(3L).getDataModel().getClass("Person"))}, "abcNames(p..firstName + ' ' + p..lastName) like ?abcSearchLike or p..email like ?searchEmailLike"));
    }
