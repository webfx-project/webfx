...
class RxUi {
    ...
    static <T> Observable<T> observe(ObservableValue<T> observableValue) {
    ...
    static <T> Observable<T> observeIf(Observable<T> observable, Property<Boolean> conditionProperty) {
