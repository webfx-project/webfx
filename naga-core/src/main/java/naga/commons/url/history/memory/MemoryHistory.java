package naga.commons.url.history.memory;

import naga.commons.url.history.baseimpl.HistoryBase;
import naga.commons.url.history.baseimpl.HistoryLocationImpl;
