 ...
 * @author Bruno Salmon
 */
abstract class SwingChartPeer
        <N extends Chart, NB extends ChartPeerBase<XChartJPanel, N, NB, NM>, NM extends ChartPeerMixin<XChartJPanel, N, NB, NM>>

        extends SwingRegionPeer<N, NB, NM>
        implements ChartPeerMixin<XChartJPanel, N, NB, NM>, SwingLayoutMeasurable<N> {

    private final XChartJPanel xChartJPanel = new XChartJPanel();

    SwingChartPeer(NB base) {
        super(base);
    }
