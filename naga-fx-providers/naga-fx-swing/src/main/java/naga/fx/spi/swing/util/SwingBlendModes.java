 ...
 * @author Bruno Salmon
 */
public class SwingBlendModes {

    public static Composite toComposite(BlendMode blendMode, Double opacity) {
        if (blendMode == null && opacity == null)
            return null;
        float alpha = opacity == null ? 1f : opacity.floatValue();
        if (blendMode == null)
        ...
        switch (blendMode) {
            ...
            case ADD: return BlendComposite.getInstance(BlendComposite.BlendingMode.ADD, alpha);
            case MULTIPLY: return BlendComposite.getInstance(BlendComposite.BlendingMode.MULTIPLY, alpha);
            case SCREEN: return BlendComposite.getInstance(BlendComposite.BlendingMode.SCREEN, alpha);
            case OVERLAY: return BlendComposite.getInstance(BlendComposite.BlendingMode.OVERLAY, alpha);
            case DARKEN: return BlendComposite.getInstance(BlendComposite.BlendingMode.DARKEN, alpha);
            case LIGHTEN: return BlendComposite.getInstance(BlendComposite.BlendingMode.LIGHTEN, alpha);
            case COLOR_DODGE: return BlendComposite.getInstance(BlendComposite.BlendingMode.COLOR_DODGE, alpha);
            case COLOR_BURN: return BlendComposite.getInstance(BlendComposite.BlendingMode.COLOR_BURN, alpha);
            case HARD_LIGHT: return BlendComposite.getInstance(BlendComposite.BlendingMode.HARD_LIGHT, alpha);
            case SOFT_LIGHT: return BlendComposite.getInstance(BlendComposite.BlendingMode.SOFT_LIGHT, alpha);
            case DIFFERENCE: return BlendComposite.getInstance(BlendComposite.BlendingMode.DIFFERENCE, alpha);
            case EXCLUSION: return BlendComposite.getInstance(BlendComposite.BlendingMode.EXCLUSION, alpha);
            case RED: return BlendComposite.getInstance(BlendComposite.BlendingMode.RED, alpha);
            case GREEN: return BlendComposite.getInstance(BlendComposite.BlendingMode.GREEN, alpha);
            case BLUE: return BlendComposite.getInstance(BlendComposite.BlendingMode.BLUE, alpha);
        }
        return null;
    }
