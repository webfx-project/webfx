...
import emul.com.sun.javafx.event.DirectEvent;
import emul.com.sun.javafx.event.EventHandlerManager;
import emul.com.sun.javafx.event.EventRedirector;
...
import emul.javafx.beans.value.WeakChangeListener;
...
import emul.com.sun.javafx.stage.PopupWindowPeerListener;
import emul.com.sun.javafx.stage.WindowCloseRequestHandler;
 ...
 * based windows including {@link Popup} and {@link emul.javafx.scene.control.Tooltip}
 * and {@link emul.javafx.scene.control.ContextMenu}.
 * <p>
...
*/
     ...
     * owner window.
     */
    private Property<Window> ownerWindow =
            new SimpleObjectProperty<>(this, "ownerWindow");
     ...
     */
    private Property<Node> ownerNode =
            new SimpleObjectProperty<>(this, "ownerNode");
     ...
     * @param scene
     */
    @Override public final void setScene(Scene scene) {
